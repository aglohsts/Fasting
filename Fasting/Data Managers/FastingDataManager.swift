...
class FastingDataManager: ObservableObject {
    ...
    @Published var planData: [Plan] = [
        Plan(id: UUID().uuidString, tag: .beginner, name: "test name", content: PlanContent(fasting: 13, eating: 11), description: "test description description description description description description", detail: "test detail test detail test detail test detail test detail test detail test detail test detail test detail test detail test detail test detail"),
        Plan(id: UUID().uuidString, tag: .beginner, name: "test name", content: PlanContent(fasting: 16, eating: 8), description: "test description description description description description description", detail: "test detail test detail test detail test detail test detail test detail test detail test detail test detail test detail test detail test detail"),
